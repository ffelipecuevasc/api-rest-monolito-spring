package br.com.alura.produto.domain.util;
...
public final class ReflectionUtil {
    ...
    public static ReflectionUtil afirmaQueElObjeto(Object actual) {
        return new ReflectionUtil(actual);
    }

    public void tieneLosMismosCamposQue(Object esperado, String... exceto) {
        try {
    ...
    public void noTieneCamposVacios() {
        noTieneCamposVacios(actual.getClass());
    }

    private void noTieneCamposVacios(Class<?> clazz) {
        try {
            ...
            if (superClass != Object.class)
                noTieneCamposVacios(superClass);
    ...
    public void tieneTodosLosCamposVacios(String... exceto) {
        try {
            var fields = actual.getClass().getDeclaredFields();
            for (var field : fields) {
                field.setAccessible(true);
    ...
    public void tuvoTodosLosMetodosGetVerificadosAlMenosUnaVez() {
        tuvoTodosLosMetodosGetVerificadosAlMenosUnaVez(actual.getClass());
    }

    private void tuvoTodosLosMetodosGetVerificadosAlMenosUnaVez(Class<?> clazz) {
        ...
        try {
            ...
            var superClass = clazz.getSuperclass();
            if (superClass != Object.class)
                tuvoTodosLosMetodosGetVerificadosAlMenosUnaVez(superClass);
